...
import { NavigationMenu, NavigationMenuContent, NavigationMenuItem, NavigationMenuLink, NavigationMenuList, NavigationMenuTrigger, navigationMenuTriggerStyle } from '../ui/NavigationMenu';
  ...
  return (
    <header className='flex items-center gap-8 h-16 px-8 border-b'>
        ...
        <div className='basis-[300px]'>
          <Input type="text" placeholder="Search tasks" endIcon={(
            <kbd className="pointer-events-none absolute inset-y-2 right-2 rtl:left-2 rtl:right-auto hidden h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium opacity-100 sm:flex"><span className="text-xs">⌘</span>K</kbd>
          )} />
        </div>
